...
export default function Header({ onMenuClick }) {
  ...
  return (
    <div className="sticky top-0 z-40">
      <header
        className="h-16 flex items-center justify-between px-3 sm:px-6 gap-3"
      ...
      >
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          <button
            ...
            className={`sm:hidden flex items-center justify-center w-9 h-9 rounded-lg transition-all shrink-0 ${
              searchOpen
                ? "bg-violet-600 text-white border-violet-500"
                : "text-slate-400 hover:bg-[#252840] hover:text-violet-400"
            }`}
            style={{ backgroundColor: searchOpen ? undefined : "#0f1117", border: "1px solid #2a2d3e" }}
            aria-label="Search"
          >
            <Search size={16} />
          </button>
      ...
      <div
        ...
        style={{ backgroundColor: "#1a1d27", borderBottom: searchOpen ? "1px solid #2a2d3e" : "none" }}
      >
        <div className="px-3 py-2.5">
          <div
            className="flex items-center gap-2 rounded-lg px-3 py-2 w-full focus-within:border-violet-500 focus-within:shadow-[0_0_0_2px_rgba(108,99,255,0.15)] transition-all"
            style={{ backgroundColor: "#0f1117", border: "1px solid #2a2d3e" }}
          >
            <Search size={14} className="text-slate-500 shrink-0" />
            <input
            ...
            <button
              ...
              className="text-slate-500 hover:text-slate-300 transition-colors shrink-0 text-xs font-semibold"
            >
              ✕
            </button>
          </div>
