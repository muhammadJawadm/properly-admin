...
export default function Sidebar({ collapsed, setCollapsed }) {
  ...
  return (
    <aside
      className="fixed top-0 left-0 h-screen flex flex-col z-50 overflow-hidden transition-[width] duration-300 ease-in-out"
      style={{
    ...
    >
      ...
      >
        ...
        <button
          ...
          className={`flex items-center justify-center w-6 h-6 rounded-md text-slate-500 hover:text-violet-400 transition-all ${
