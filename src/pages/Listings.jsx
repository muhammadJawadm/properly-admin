  ...
  return (
    <div className="fixed inset-0 z-[300] flex" style={{ backgroundColor:"rgba(0,0,0,0.75)", backdropFilter:"blur(6px)" }}>
      ...
      <div className="relative flex flex-col w-full h-full overflow-hidden" style={{ backgroundColor:"#0f1117" }}>
        ...
        {/* ── Sticky header ── */}
        <div className="flex-shrink-0 flex items-center justify-between px-8 py-4 z-10"
             style={{ backgroundColor:"#1a1d27", borderBottom:"1px solid #2a2d3e" }}>
          <div className="flex items-center gap-4">
            <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ background:"rgba(108,99,255,0.15)", border:"1px solid rgba(108,99,255,0.3)" }}>
              <Home size={16} className="text-[#6c63ff]" />
            </div>
            <div>
              <h2 className="text-lg font-bold text-slate-100 leading-none">{listing.title}</h2>
        ...
        {/* ── Sticky footer ── */}
        <div className="flex-shrink-0 flex items-center justify-between px-8 py-4 gap-3 flex-wrap"
