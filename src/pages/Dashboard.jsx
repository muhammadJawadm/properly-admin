    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              ...
              {pieData.map(item => {
                ...
                return (
                  <button
                    ...
                    className="flex items-center gap-2 rounded-xl px-1 py-2 md:py-4 md:px-4 transition-all cursor-pointer text-left"
                    style={{
        ...
        <div className="rounded-2xl p-5" style={{ backgroundColor: "#1e2130", border: "1px solid #2a2d3e" }}>
          ...
          <div className="flex flex-col gap-0.5 overflow-x-auto w-full">
            {activity.map(item => (
              <div key={item.id} className="flex items-start sm:items-center justify-between px-3 py-2.5 rounded-xl hover:bg-[#252840] transition-colors gap-2">
                <div className="flex items-start sm:items-center gap-2 sm:gap-3 min-w-0">
                  <span className="text-xs font-bold text-violet-400 bg-violet-500/10 px-2 py-0.5 rounded-md whitespace-nowrap shrink-0">{item.id}</span>
                  <div className="min-w-0">
                    <div className="text-[13px] font-semibold text-slate-100 truncate">{item.type}</div>
                    <div className="text-[11.5px] text-slate-500 truncate">{item.user} · <span className="text-slate-400">{item.role}</span></div>
                  </div>
                </div>
